...
const NewTasks = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                ...
                const url = 'https://task-manager-app-smoky-seven.vercel.app/api/tasks/completed';
    ...
    const submitStatus = async (e, id) => {
        ...
        try {
            ...
            const url = `https://task-manager-app-smoky-seven.vercel.app/api/updateTask/${id}`;
    ...
    return (
        <div className="p-4">
            <h2 className='text-2xl font-semibold uppercase py-2'>Completed Tasks</h2>
                ...
                {data?.map((d) => (
                    <div key={d._id} className='rounded-lg bg-white shadow-md border border-gray-100 flex flex-col p-4 justify-between gap-3 hover:shadow-lg transition-shadow'>
                        ...
                        <div className='flex justify-between items-center pt-2 border-t border-gray-50 mt-2'>
                            ...
                            <span className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded-full bg-orange-400 text-white`}>
                                {d.status}
                            </span>
                        </div>
                    </div>
                ...
                <div className='fixed inset-0 flex justify-center items-center bg-black/50 z-50'>
                    <div className='bg-[#FFFFFF] w-80 rounded-lg shadow-xl p-6 flex flex-col gap-4'>
                        <div className='flex justify-between items-center'>
                            <h2 className='uppercase font-semibold text-gray-700'>Update task status</h2>
                            <button className='text-gray-400 hover:text-gray-600' onClick={() => setEditModal(false)}>✕</button>
                        </div>
                        ...
                        <form onSubmit={(e) => submitStatus(e, editId)}>
                            <button
                                type="submit"
