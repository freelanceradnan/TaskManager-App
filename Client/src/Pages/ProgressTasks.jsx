...
const NewTasks = () => {
    ...
    const getData=async()=>{
        try {
          ...
          const url='https://task-manager-app-smoky-seven.vercel.app/api/tasks/progress'
  ...
  try {
    ...
    const url = `https://task-manager-app-smoky-seven.vercel.app/api/updateTask/${editId}`; 
    ...
    return (
        <div>
           <h2 className='text-2xl font-semibold uppercase py-2'>Progress Tasks</h2>
...
>
    ...
    <span className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded-full bg-pink-400 text-white`}>
      {d.status}
    </span>
